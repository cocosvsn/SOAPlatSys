...
import com.cbs.cbsmgr.serviceiface.IVodHistoryTempService;

public class VodHistoryTempService implements IVodHistoryTempService {

	public IVodHistoryTempManager vodHistoryTempManager = null;
	
	public VodHistoryTempService(/*IVodHistoryTempManager vodHistoryTempManager*/)
	{
	...
	public void delete(Object[] object) {
		...
		vodHistoryTempManager.delete(object);
	}

	public void deleteById(String pkid) {
		// TODO Auto-generated method stub
		vodHistoryTempManager.deleteById(pkid);
	}

	public List findAll() {
		// TODO Auto-generated method stub
		List list = vodHistoryTempManager.findAll();
		return list;
	}

	public List findByProperty(String propertyName, Object value) {
		// TODO Auto-generated method stub
		List list = vodHistoryTempManager.findByProperty(propertyName, value);
		return list;
	}

	public Object getById(String pkid) {
		// TODO Auto-generated method stub
		Object object = vodHistoryTempManager.getById(pkid);
		return object;
	}

	public Object loadById(String pkid) {
		// TODO Auto-generated method stub
		Object object = vodHistoryTempManager.loadById(pkid);
		return object;
	}

	public Object save(Object object) {
		// TODO Auto-generated method stub
		Object saveobject = vodHistoryTempManager.save(object);
		return saveobject;
	}

	public void save(Object[] object) {
		// TODO Auto-generated method stub
		vodHistoryTempManager.save(object);
	}

	public void update(Object object) {
		// TODO Auto-generated method stub
		vodHistoryTempManager.update(object);
	}
	...
	public List findbyExample(Object exampleentity) {
		List list = vodHistoryTempManager.findbyExample(exampleentity);
		return list;
	}
}
