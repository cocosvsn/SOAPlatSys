...
/**
 * ConsumeListHis entity. @author MyEclipse Persistence Tools
 */

public class ConsumeListHis  implements java.io.Serializable {
    ...
    /** default constructor */
    public ConsumeListHis() {
    }

	/** minimal constructor */
    public ConsumeListHis(String relid) {
        this.relid = relid;
    }
    
    /** full constructor */
    public ConsumeListHis(String relid, String vodsid, String vodsip, String ipqamchannelprogid, String casturl, String ipqamchannelid, String programid, String productid, String stbid, String stbmac, String stbip, String smartcardid, String sessionid, Date starttime, Date endtime, String desresouce, Integer sendflag, String inputmanid, Date inputtime, String remark) {
        this.relid = relid;
        this.vodsid = vodsid;
        this.vodsip = vodsip;
