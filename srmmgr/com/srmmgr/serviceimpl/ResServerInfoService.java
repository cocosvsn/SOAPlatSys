...
import com.srmmgr.manageriface.IResServerInfoManager;
import com.srmmgr.serviceiface.IResServerInfoService;

/**
 * Title 		:the Class ResServerInfoService.
 * Description	:
 ...
 * @version		:1.0
 */
public class ResServerInfoService implements IResServerInfoService {

	/** The resserverinfo manager. */
	public IResServerInfoManager resserverinfoManager=null;
	
	/**
	 * Instantiates a new resserverinfo service.
	 */
	public ResServerInfoService() {
		resserverinfoManager=(IResServerInfoManager)ApplicationContextHolder.webApplicationContext.getBean("resserverinfoManager");
	}
	...
	public void delete(Object[] object) {
		resserverinfoManager.delete(object);
	...
	public void deleteById(String pkid) {
		resserverinfoManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=resserverinfoManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=resserverinfoManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=resserverinfoManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=resserverinfoManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=resserverinfoManager.save(object);
		return saveobject;
	}
	...
	public void save(Object[] object) {
		resserverinfoManager.save(object);
	...
	public void update(Object object) {
		resserverinfoManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=resserverinfoManager.findbyExample(exampleentity);
		return list;
	}
