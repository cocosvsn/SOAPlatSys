...
import com.srmmgr.manageriface.IDistrictManager;
import com.srmmgr.serviceiface.IDistrictService;

/**
 * Title 		:the Class DistrictService.
 * Description	:
...
public class DistrictService implements IDistrictService {
	...
	public IDistrictManager districtManager=null;
	
	/**
	 * Instantiates a new district service.
	 */
	public DistrictService() {
		districtManager=(IDistrictManager)ApplicationContextHolder.webApplicationContext.getBean("districtManager");
	}
	...
	public void deleteById(String pkid) {
		districtManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=districtManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=districtManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=districtManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=districtManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=districtManager.save(object);
		return saveobject;
	}
	...
	public List findbyExample(Object exampleentity) {
		List list=districtManager.findbyExample(exampleentity);
		return list;
	}
