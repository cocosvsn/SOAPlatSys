...
import com.srmmgr.serviceiface.ICmdConsumeListService;

/**
 * Title 		:the Class CmdConsumeListService.
 * Description	:
 ...
 * @version		:1.0
 */
public class CmdConsumeListService implements ICmdConsumeListService {

	/** The cmdconsumelist manager. */
	public ICmdConsumeListManager cmdconsumelistManager=null;
	
	/**
	 * Instantiates a new consume detail service.
	 */
	public CmdConsumeListService() {
		cmdconsumelistManager=(ICmdConsumeListManager)ApplicationContextHolder.webApplicationContext.getBean("cmdconsumelistManager");
	}
	...
	public void delete(Object[] object) {
		cmdconsumelistManager.delete(object);
	...
	public void deleteById(String pkid) {
		cmdconsumelistManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=cmdconsumelistManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=cmdconsumelistManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=cmdconsumelistManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=cmdconsumelistManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=cmdconsumelistManager.save(object);
		return saveobject;
	}
	...
	public void save(Object[] object) {
		cmdconsumelistManager.save(object);
	...
	public void update(Object object) {
		cmdconsumelistManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=cmdconsumelistManager.findbyExample(exampleentity);
		return list;
	}
