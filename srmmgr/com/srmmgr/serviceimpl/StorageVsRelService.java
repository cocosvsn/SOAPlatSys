...
import com.srmmgr.serviceiface.IStorageVsRelService;

/**
 * Title 		:the Class StorageVsRelService.
 * Description	:
 ...
 * @version		:1.0
 */
public class StorageVsRelService implements IStorageVsRelService {

	/** The storagevsrel manager. */
	public IStorageVsRelManager storagevsrelManager=null;
	
	/**
	 * Instantiates a new storage vs rel service.
	 */
	public StorageVsRelService() {
	...
	public void delete(Object[] object) {
		storagevsrelManager.delete(object);
	...
	public void deleteById(String pkid) {
		storagevsrelManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=storagevsrelManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=storagevsrelManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=storagevsrelManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=storagevsrelManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=storagevsrelManager.save(object);
		return saveobject;
	}
	...
	public void save(Object[] object) {
		storagevsrelManager.save(object);
	...
	public void update(Object object) {
		storagevsrelManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=storagevsrelManager.findbyExample(exampleentity);
		return list;
	}

	public List getVsStorages(String vodsid) {
		List list=storagevsrelManager.getVsStorages(vodsid);
		return list;
	}
