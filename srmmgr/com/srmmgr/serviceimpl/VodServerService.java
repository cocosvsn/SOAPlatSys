...
import com.srmmgr.serviceiface.IVodServerService;

/**
 * Title 		:the Class VodServerService.
 * Description	:
 ...
 * @version		:1.0
 */
public class VodServerService implements IVodServerService {

	/** The vodserver manager. */
	public IVodServerManager vodserverManager=null;
	
	/**
	 * Instantiates a new vod server service.
	 */
	public VodServerService() {
		vodserverManager=(IVodServerManager)ApplicationContextHolder.webApplicationContext.getBean("vodserverManager");
	}
	...
	public void delete(Object[] object) {
		vodserverManager.delete(object);
	...
	public void deleteById(String pkid) {
		vodserverManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=vodserverManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=vodserverManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=vodserverManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=vodserverManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=vodserverManager.save(object);
		return saveobject;
	}
	...
	public void update(Object object) {
		vodserverManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=vodserverManager.findbyExample(exampleentity);
		return list;
	}
