...
import com.srmmgr.manageriface.IVodServerUsageManager;
import com.srmmgr.serviceiface.IVodServerUsageService;

/**
 * Title 		:the Class VodServerUsageService.
 * Description	:
 ...
 * @version		:1.0
 */
public class VodServerUsageService implements IVodServerUsageService {

	/** The vodserverusage manager. */
	public IVodServerUsageManager vodserverusageManager=null;
	
	/**
	 * Instantiates a new vod server usage service.
	 */
	public VodServerUsageService() {
		vodserverusageManager=(IVodServerUsageManager)ApplicationContextHolder.webApplicationContext.getBean("vodserverusageManager");
	}
	...
	public void delete(Object[] object) {
		vodserverusageManager.delete(object);
	...
	public void deleteById(String pkid) {
		vodserverusageManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=vodserverusageManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=vodserverusageManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=vodserverusageManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=vodserverusageManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=vodserverusageManager.save(object);
		return saveobject;
	}
	...
	public void save(Object[] object) {
		vodserverusageManager.save(object);
	...
	public void update(Object object) {
		vodserverusageManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=vodserverusageManager.findbyExample(exampleentity);
		return list;
	}
