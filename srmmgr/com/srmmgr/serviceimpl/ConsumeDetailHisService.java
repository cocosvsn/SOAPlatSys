...
import com.srmmgr.serviceiface.IConsumeDetailHisService;

/**
 * Title 		:the Class ConsumeDetailHisService.
 * Description	:
 ...
 * @version		:1.0
 */
public class ConsumeDetailHisService implements IConsumeDetailHisService {

	/** The consumedetailhis manager. */
	public IConsumeDetailHisManager consumedetailhisManager=null;
	
	/**
	 * Instantiates a new consumedetailhis service.
	 */
	public ConsumeDetailHisService() {
		consumedetailhisManager=(IConsumeDetailHisManager)ApplicationContextHolder.webApplicationContext.getBean("consumedetailhisManager");
	}
	...
	public void delete(Object[] object) {
		consumedetailhisManager.delete(object);
	...
	public void deleteById(String pkid) {
		consumedetailhisManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=consumedetailhisManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=consumedetailhisManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=consumedetailhisManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=consumedetailhisManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=consumedetailhisManager.save(object);
		return saveobject;
	}
	...
	public void save(Object[] object) {
		consumedetailhisManager.save(object);
	...
	public void update(Object object) {
		consumedetailhisManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=consumedetailhisManager.findbyExample(exampleentity);
		return list;
	}
