...
import com.srmmgr.serviceiface.IConsumeDetailService;

/**
 * Title 		:the Class ConsumeDetailService.
 * Description	:
 ...
 * @version		:1.0
 */
public class ConsumeDetailService implements IConsumeDetailService {

	/** The consumedetail manager. */
	public IConsumeDetailManager consumedetailManager=null;
	
	/**
	 * Instantiates a new consume detail service.
	 */
	public ConsumeDetailService() {
		consumedetailManager=(IConsumeDetailManager)ApplicationContextHolder.webApplicationContext.getBean("consumedetailManager");
	}
	...
	public void delete(Object[] object) {
		consumedetailManager.delete(object);
	...
	public void deleteById(String pkid) {
		consumedetailManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=consumedetailManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=consumedetailManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=consumedetailManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=consumedetailManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=consumedetailManager.save(object);
		return saveobject;
	}
	...
	public void save(Object[] object) {
		consumedetailManager.save(object);
	...
	public void update(Object object) {
		consumedetailManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=consumedetailManager.findbyExample(exampleentity);
		return list;
	}
