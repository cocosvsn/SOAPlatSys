...
import com.srmmgr.serviceiface.IIpQamChannelProgNoService;

/**
 * Title 		:the Class IpQamChannelProgNoService.
 * Description	:
 ...
 * @version		:1.0
 */
public class IpQamChannelProgNoService implements IIpQamChannelProgNoService {

	/** The ipqamchannelprogno manager. */
	public IIpQamChannelProgNoManager ipqamchannelprognoManager=null;
	
	/**
	 * Instantiates a new ipqamchannelprogno service.
	 */
	public IpQamChannelProgNoService() {
		ipqamchannelprognoManager=(IIpQamChannelProgNoManager)ApplicationContextHolder.webApplicationContext.getBean("ipqamchannelprognoManager");
	}
	...
	public void delete(Object[] object) {
		ipqamchannelprognoManager.delete(object);
	...
	public void deleteById(String pkid) {
		ipqamchannelprognoManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=ipqamchannelprognoManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=ipqamchannelprognoManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=ipqamchannelprognoManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=ipqamchannelprognoManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=ipqamchannelprognoManager.save(object);
		return saveobject;
	}
	...
	public void save(Object[] object) {
		ipqamchannelprognoManager.save(object);
	...
	public void update(Object object) {
		ipqamchannelprognoManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=ipqamchannelprognoManager.findbyExample(exampleentity);
		return list;
	}
