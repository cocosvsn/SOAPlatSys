...
import com.srmmgr.serviceiface.IWebServerService;

/**
 * Title 		:the Class WebServerService.
 * Description	:
...
public class WebServerService implements IWebServerService {
	...
	public void delete(Object[] object) {
		webserverManager.delete(object);
	...
	public void deleteById(String pkid) {
		webserverManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=webserverManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=webserverManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=webserverManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=webserverManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=webserverManager.save(object);
		return saveobject;
	}
	...
	public void update(Object object) {
		webserverManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=webserverManager.findbyExample(exampleentity);
		return list;
	}
