...
import com.srmmgr.serviceiface.IStbCustomerAuthService;

/**
 * Title 		:the Class StbCustomerAuthService.
 * Description	:
 ...
 * @version		:1.0
 */
public class StbCustomerAuthService implements IStbCustomerAuthService {

	/** The stbcustomerauth manager. */
	public IStbCustomerAuthManager stbcustomerauthManager=null;
	
	/**
	 * Instantiates a new stbcustomerauth service.
	 */
	public StbCustomerAuthService() {
		stbcustomerauthManager=(IStbCustomerAuthManager)ApplicationContextHolder.webApplicationContext.getBean("stbcustomerauthManager");
	}
	...
	public void delete(Object[] object) {
		stbcustomerauthManager.delete(object);
	...
	public void deleteById(String pkid) {
		stbcustomerauthManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=stbcustomerauthManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=stbcustomerauthManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=stbcustomerauthManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=stbcustomerauthManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=stbcustomerauthManager.save(object);
		return saveobject;
	}
	...
	public void save(Object[] object) {
		stbcustomerauthManager.save(object);
	...
	public void update(Object object) {
		stbcustomerauthManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=stbcustomerauthManager.findbyExample(exampleentity);
		return list;
	}
