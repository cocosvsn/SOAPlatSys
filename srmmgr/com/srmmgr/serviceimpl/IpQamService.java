...
import com.srmmgr.manageriface.IIpQamManager;
import com.srmmgr.serviceiface.IIpQamService;

/**
 * Title 		:the Class IpQamService.
 * Description	:
 ...
 * @version		:1.0
 */
public class IpQamService implements IIpQamService {

	/** The ipqam manager. */
	public IIpQamManager ipqamManager=null;
	
	/**
	 * Instantiates a new ip qam service.
	 */
	public IpQamService() {
		ipqamManager=(IIpQamManager)ApplicationContextHolder.webApplicationContext.getBean("ipqamManager");
	}
	 ...
	 */
	public List findAll() {
		List list=ipqamManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=ipqamManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=ipqamManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=ipqamManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=ipqamManager.save(object);
		return saveobject;
	}
	...
	public List findbyExample(Object exampleentity) {
		List list=ipqamManager.findbyExample(exampleentity);
		return list;
	}
