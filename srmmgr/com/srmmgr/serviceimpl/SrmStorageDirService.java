...
import com.srmmgr.serviceiface.ISrmStorageDirService;

/**
 * Title 		:the Class SrmStorageDirService.
 * Description	:
 ...
 * @version		:1.0
 */
public class SrmStorageDirService implements ISrmStorageDirService {

	/** The srmstoragedir manager. */
	public ISrmStorageDirManager srmstoragedirManager=null;
	
	/**
	 * Instantiates a new srmstoragedir service.
	 */
	public SrmStorageDirService() {
		srmstoragedirManager=(ISrmStorageDirManager)ApplicationContextHolder.webApplicationContext.getBean("srmstoragedirManager");
	}
	...
	public void delete(Object[] object) {
		srmstoragedirManager.delete(object);
	...
	public void deleteById(String pkid) {
		srmstoragedirManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=srmstoragedirManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=srmstoragedirManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=srmstoragedirManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=srmstoragedirManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=srmstoragedirManager.save(object);
		return saveobject;
	}
	...
	public void save(Object[] object) {
		srmstoragedirManager.save(object);
	...
	public void update(Object object) {
		srmstoragedirManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=srmstoragedirManager.findbyExample(exampleentity);
		return list;
	}
