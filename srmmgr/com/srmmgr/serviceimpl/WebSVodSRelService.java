...
import com.srmmgr.serviceiface.IWebSVodSRelService;

/**
 * Title 		:the Class WebSVodSRelService.
 * Description	:
 ...
 * @version		:1.0
 */
public class WebSVodSRelService implements IWebSVodSRelService {

	/** The websvodsrel manager. */
	public IWebSVodSRelManager websvodsrelManager=null;
	
	/**
	 * Instantiates a new web s vod s rel service.
	 */
	public WebSVodSRelService() {
	...
	public void delete(Object[] object) {
		websvodsrelManager.delete(object);
	...
	public void deleteById(String pkid) {
		websvodsrelManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=websvodsrelManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=websvodsrelManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=websvodsrelManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=websvodsrelManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=websvodsrelManager.save(object);
		return saveobject;
	}
	...
	public void save(Object[] object) {
		websvodsrelManager.save(object);
	...
	public void update(Object object) {
		websvodsrelManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=websvodsrelManager.findbyExample(exampleentity);
		return list;
	}

	public List getWebSVodSs(String websid) {
		List list=websvodsrelManager.getWebSVodSs(websid);
		return list;
	}
