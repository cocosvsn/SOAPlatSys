...
import com.srmmgr.manageriface.IProgProductRelManager;
import com.srmmgr.serviceiface.IProgProductRelService;

/**
 * Title 		:the Class ProgProductRelService.
 * Description	:
 ...
 * @version		:1.0
 */
public class ProgProductRelService implements IProgProductRelService {

	/** The progproductrel manager. */
	public IProgProductRelManager progproductrelManager=null;
	
	/**
	 * Instantiates a new progproductrel service.
	 */
	public ProgProductRelService() {
		progproductrelManager=(IProgProductRelManager)ApplicationContextHolder.webApplicationContext.getBean("progproductrelManager");
	}
	...
	public void delete(Object[] object) {
		progproductrelManager.delete(object);
	...
	public void deleteById(String pkid) {
		progproductrelManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=progproductrelManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=progproductrelManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=progproductrelManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=progproductrelManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=progproductrelManager.save(object);
		return saveobject;
	}
	...
	public void save(Object[] object) {
		progproductrelManager.save(object);
	...
	public void update(Object object) {
		progproductrelManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=progproductrelManager.findbyExample(exampleentity);
		return list;
	}
