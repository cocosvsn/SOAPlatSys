...
import com.srmmgr.serviceiface.ISrmStoragePrgRelService;

/**
 * Title 		:the Class SrmStoragePrgRelService.
 * Description	:
 ...
 * @version		:1.0
 */
public class SrmStoragePrgRelService implements ISrmStoragePrgRelService {

	/** The srmstorageprgrel manager. */
	public ISrmStoragePrgRelManager srmstorageprgrelManager=null;
	
	/**
	 * Instantiates a new srmstorageprgrel service.
	 */
	public SrmStoragePrgRelService() {
		srmstorageprgrelManager=(ISrmStoragePrgRelManager)ApplicationContextHolder.webApplicationContext.getBean("srmstorageprgrelManager");
	}
	...
	public void delete(Object[] object) {
		srmstorageprgrelManager.delete(object);
	...
	public void deleteById(String pkid) {
		srmstorageprgrelManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=srmstorageprgrelManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=srmstorageprgrelManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=srmstorageprgrelManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=srmstorageprgrelManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=srmstorageprgrelManager.save(object);
		return saveobject;
	}
	...
	public void save(Object[] object) {
		srmstorageprgrelManager.save(object);
	...
	public void update(Object object) {
		srmstorageprgrelManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=srmstorageprgrelManager.findbyExample(exampleentity);
		return list;
	}
