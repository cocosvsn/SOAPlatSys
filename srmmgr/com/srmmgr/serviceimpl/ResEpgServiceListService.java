...
import com.srmmgr.manageriface.IResEpgServiceListManager;
import com.srmmgr.serviceiface.IResEpgServiceListService;

/**
 * Title 		:the Class ResEpgServiceListService.
 * Description	:
 ...
 * @version		:1.0
 */
public class ResEpgServiceListService implements IResEpgServiceListService {

	/** The resepgservicelist manager. */
	public IResEpgServiceListManager resepgservicelistManager=null;
	
	/**
	 * Instantiates a new resepgservicelist service.
	 */
	public ResEpgServiceListService() {
		resepgservicelistManager=(IResEpgServiceListManager)ApplicationContextHolder.webApplicationContext.getBean("resepgservicelistManager");
	}
	...
	public void delete(Object[] object) {
		resepgservicelistManager.delete(object);
	...
	public void deleteById(String pkid) {
		resepgservicelistManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=resepgservicelistManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=resepgservicelistManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=resepgservicelistManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=resepgservicelistManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=resepgservicelistManager.save(object);
		return saveobject;
	}
	...
	public void save(Object[] object) {
		resepgservicelistManager.save(object);
	...
	public void update(Object object) {
		resepgservicelistManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=resepgservicelistManager.findbyExample(exampleentity);
		return list;
	}
