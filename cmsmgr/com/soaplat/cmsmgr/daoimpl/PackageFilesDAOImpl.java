...
public class PackageFilesDAOImpl implements IPackageFilesDAO {
	...
	public void deleteById(String pkid) {
		...
		PackageFiles packageFiles = (PackageFiles)baseDAO.getById(PackageFiles.class, Long.valueOf(pkid));
		if(packageFiles != null){
			baseDAO.delete(packageFiles);
		}
	}
	 ...
	 */
	public List findAll() {
		List list = baseDAO.findAll("PackageFiles", "cmspackageFilesid");
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list = baseDAO.findByProperty("PackageFiles", propertyName, value);
		return list;
	}
	 ...
	 */
	public PackageFiles getById(String pkid) {
		PackageFiles packageFiles = (PackageFiles)baseDAO.getById(PackageFiles.class, Long.valueOf(pkid));
		return packageFiles;
	}
	 ...
	 */
	public PackageFiles loadById(String pkid) {
		PackageFiles packageFiles = (PackageFiles)baseDAO.loadById(PackageFiles.class, Long.valueOf(pkid));
		return packageFiles;
	}
	 ...
	 */
	public PackageFiles save(PackageFiles packageFiles) {
	 ...
	 */
	public void update(PackageFiles packageFiles) {
		baseDAO.update(packageFiles);
	}
