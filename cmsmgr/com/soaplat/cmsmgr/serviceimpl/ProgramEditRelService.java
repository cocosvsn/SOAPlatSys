...
import com.soaplat.cmsmgr.manageriface.IProgramEditRelManager;
import com.soaplat.cmsmgr.serviceiface.IProgramEditRelService;

/**
 * Title 		:the Class ProgramEditRelService.
 * Description	:
 ...
 * @version		:1.0
 */
public class ProgramEditRelService implements IProgramEditRelService {

	/** The programeditrel manager. */
	public IProgramEditRelManager programeditrelManager=null;
	
	/**
	 * Instantiates a new programeditrel service.
	 * 
	 * @param programeditrelManager the programeditrel manager
	 */
	public ProgramEditRelService() {
		programeditrelManager=(IProgramEditRelManager)ApplicationContextHolder.webApplicationContext.getBean("programeditrelManager");
	}
	...
	public void delete(Object[] object) {
		programeditrelManager.delete(object);
	...
	public void deleteById(String pkid) {
		programeditrelManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=programeditrelManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=programeditrelManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=programeditrelManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=programeditrelManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=programeditrelManager.save(object);
		return saveobject;
	}
	...
	public void save(Object[] object) {
		programeditrelManager.save(object);
	...
	public void update(Object object) {
		programeditrelManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=programeditrelManager.findbyExample(exampleentity);
		return list;
	}
