...
import com.soaplat.cmsmgr.serviceiface.IProgIndexInfoService;

/**
 * Title 		:the Class ProgIndexInfoService.
 * Description	:
 ...
 * @version		:1.0
 */
public class ProgIndexInfoService implements IProgIndexInfoService {

	/** The progindexinfo manager. */
	public IProgIndexInfoManager progindexinfoManager=null;
	
	/**
	 * Instantiates a new progindexinfo service.
	 * 
	 * @param progindexinfoManager the progindexinfo manager
	 */
	public ProgIndexInfoService() {
		progindexinfoManager=(IProgIndexInfoManager)ApplicationContextHolder.webApplicationContext.getBean("progindexinfoManager");
	}
	...
	public void delete(Object[] object) {
		progindexinfoManager.delete(object);
	...
	public void deleteById(String pkid) {
		progindexinfoManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=progindexinfoManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=progindexinfoManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=progindexinfoManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=progindexinfoManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=progindexinfoManager.save(object);
		return saveobject;
	}
	...
	public void save(Object[] object) {
		progindexinfoManager.save(object);
	...
	public void update(Object object) {
		progindexinfoManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=progindexinfoManager.findbyExample(exampleentity);
		return list;
	}
