...
import com.soaplat.cmsmgr.serviceiface.IProgramFilesService;

/**
 * Title 		:the Class ProgramFilesService.
 * Description	:
 ...
 * @version		:1.0
 */
public class ProgramFilesService implements IProgramFilesService {

	/** The programfiles manager. */
	public IProgramFilesManager programfilesManager=null;
	
	/**
	 * Instantiates a new programfiles service.
	 * 
	 * @param programfilesManager the programfiles manager
	 */
	public ProgramFilesService() {
	...
	public void delete(Object[] object) {
		programfilesManager.delete(object);
	...
	public void deleteById(String pkid) {
		programfilesManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=programfilesManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=programfilesManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=programfilesManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=programfilesManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=programfilesManager.save(object);
		return saveobject;
	}
	...
	public void save(Object[] object) {
		programfilesManager.save(object);
	...
	public void update(Object object) {
		programfilesManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=programfilesManager.findbyExample(exampleentity);
		return list;
	}
	public List findstoragelistbyfileid(String programid,String filetypeid) {
		List list=programfilesManager.findstoragelistbyfileid(programid, filetypeid);
		return list;
	}
	public String findmaxprogramfileidbyprogramidandfiletype(String programid,String filetypeid)
	{
		String filemaxid=programfilesManager.findmaxprogramfileidbyprogramidandfiletype(programid, filetypeid);
		return filemaxid;
	}
}
