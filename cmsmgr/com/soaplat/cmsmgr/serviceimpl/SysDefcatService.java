...
import com.soaplat.cmsmgr.manageriface.ISysDefcatManager;
import com.soaplat.cmsmgr.serviceiface.ISysDefcatService;

/**
 * Title 		:the Class SysDefcatService.
 * Description	:
 ...
 * @version		:1.0
 */
public class SysDefcatService implements ISysDefcatService {

	/** The sysdefcat manager. */
	public ISysDefcatManager sysdefcatManager=null;
	
	/**
	 * Instantiates a new sysdefcat service.
	 * 
	 * @param sysdefcatManager the sysdefcat manager
	 */
	public SysDefcatService() {
		sysdefcatManager=(ISysDefcatManager)ApplicationContextHolder.webApplicationContext.getBean("sysdefcatManager");
	}
	...
	public void delete(Object[] object) {
		sysdefcatManager.delete(object);
	...
	public void deleteById(String pkid) {
		sysdefcatManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=sysdefcatManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=sysdefcatManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=sysdefcatManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=sysdefcatManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=sysdefcatManager.save(object);
		return saveobject;
	}
	...
	public void update(Object object) {
		sysdefcatManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=sysdefcatManager.findbyExample(exampleentity);
		return list;
	}
