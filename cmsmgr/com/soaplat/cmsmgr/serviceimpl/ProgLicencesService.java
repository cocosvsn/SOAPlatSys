...
import com.soaplat.cmsmgr.serviceiface.IProgLicencesService;

/**
 * Title 		:the Class ProgLicencesService.
 * Description	:
 ...
 * @version		:1.0
 */
public class ProgLicencesService implements IProgLicencesService {

	/** The proglicences manager. */
	public IProgLicencesManager proglicencesManager=null;
	
	/**
	 * Instantiates a new proglicences service.
	 * 
	 * @param proglicencesManager the proglicences manager
	 */
	public ProgLicencesService() {
		proglicencesManager=(IProgLicencesManager)ApplicationContextHolder.webApplicationContext.getBean("proglicencesManager");
	}
	...
	public void delete(Object[] object) {
		proglicencesManager.delete(object);
	...
	public void deleteById(String pkid) {
		proglicencesManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=proglicencesManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=proglicencesManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=proglicencesManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=proglicencesManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=proglicencesManager.save(object);
		return saveobject;
	}
	...
	public void save(Object[] object) {
		proglicencesManager.save(object);
	...
	public void update(Object object) {
		proglicencesManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=proglicencesManager.findbyExample(exampleentity);
		return list;
	}
