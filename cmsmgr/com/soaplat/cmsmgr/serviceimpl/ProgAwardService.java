...
import com.soaplat.cmsmgr.manageriface.IProgAwardManager;
import com.soaplat.cmsmgr.serviceiface.IProgAwardService;

/**
 * Title 		:the Class ProgAwardService.
 * Description	:
 ...
 * @version		:1.0
 */
public class ProgAwardService implements IProgAwardService {

	/** The offlineprog manager. */
	public IProgAwardManager progawardManager=null;
	
	/**
	 * Instantiates a new progaward service.
	 * 
	 * @param progawardManager the progaward manager
	 */
	public ProgAwardService() {
		progawardManager=(IProgAwardManager)ApplicationContextHolder.webApplicationContext.getBean("progawardManager");
	}
	...
	public void delete(Object[] object) {
		progawardManager.delete(object);
	...
	public void deleteById(String pkid) {
		progawardManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=progawardManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=progawardManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=progawardManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=progawardManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=progawardManager.save(object);
		return saveobject;
	}
	...
	public void update(Object object) {
		progawardManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=progawardManager.findbyExample(exampleentity);
		return list;
	}
