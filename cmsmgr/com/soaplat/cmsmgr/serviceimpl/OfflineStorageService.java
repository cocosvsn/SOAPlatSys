...
import com.soaplat.cmsmgr.serviceiface.IOfflineStorageService;

/**
 * Title 		:the Class OfflineStorageService.
 * Description	:
 ...
 * @version		:1.0
 */
public class OfflineStorageService implements IOfflineStorageService {

	/** The offlinestorage manager. */
	public IOfflineStorageManager offlinestorageManager=null;
	
	/**
	 * Instantiates a new offlinestorage service.
	 * 
	 * @param offlinestorageManager the offlinestorage manager
	 */
	public OfflineStorageService() {
		offlinestorageManager=(IOfflineStorageManager)ApplicationContextHolder.webApplicationContext.getBean("offlinestorageManager");
	}
	...
	public void delete(Object[] object) {
		offlinestorageManager.delete(object);
	...
	public void deleteById(String pkid) {
		offlinestorageManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=offlinestorageManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=offlinestorageManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=offlinestorageManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=offlinestorageManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=offlinestorageManager.save(object);
		return saveobject;
	}
	...
	public void save(Object[] object) {
		offlinestorageManager.save(object);
	...
	public void update(Object object) {
		offlinestorageManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=offlinestorageManager.findbyExample(exampleentity);
		return list;
	}
