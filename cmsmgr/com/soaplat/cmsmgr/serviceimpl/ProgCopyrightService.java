...
import com.soaplat.cmsmgr.serviceiface.IProgCopyrightService;

/**
 * Title 		:the Class ProgCopyrightService.
 * Description	:
 ...
 * @version		:1.0
 */
public class ProgCopyrightService implements IProgCopyrightService {

	/** The progcopyright manager. */
	public IProgCopyrightManager progcopyrightManager=null;
	
	/**
	 * Instantiates a new progcopyright service.
	 * 
	 * @param progcopyrightManager the progcopyright manager
	 */
	public ProgCopyrightService() {
		progcopyrightManager=(IProgCopyrightManager)ApplicationContextHolder.webApplicationContext.getBean("progcopyrightManager");
	}
	...
	public void delete(Object[] object) {
		progcopyrightManager.delete(object);
	...
	public void deleteById(String pkid) {
		progcopyrightManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=progcopyrightManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=progcopyrightManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=progcopyrightManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=progcopyrightManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=progcopyrightManager.save(object);
		return saveobject;
	}
	...
	public void save(Object[] object) {
		progcopyrightManager.save(object);
	...
	public void update(Object object) {
		progcopyrightManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=progcopyrightManager.findbyExample(exampleentity);
		return list;
	}
