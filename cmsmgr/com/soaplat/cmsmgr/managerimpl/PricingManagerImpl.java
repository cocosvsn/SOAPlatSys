...
//		productInfo.setInvalidDate(DateUtil.parseDate("yyyy-MM-dd", defaultInvalidateStr));
	...
	public void deleteProductProgRelByProgPackageIdAndProgProductIds(
		...
		this.baseDAO.executeSQL(
				"DELETE FROM CMS.TPRODUCTPROGREL WHERE CMS.TPRODUCTPROGREL.PRODUCTID = :progPackageId AND CMS.TPRODUCTPROGREL.KEYID IN (SELECT CMS.TPROGPRODUCT.KEYID FROM CMS.TPROGPRODUCT WHERE CMS.TPROGPRODUCT.PRODUCTPROGREL IN (:progProductIds))", 
				map);
	}
