...
import com.soaplat.sysmgr.serviceiface.IRoleOperRelService;

/**
 * Title 		:the Class RoleOperRelService.
 * Description	:
 ...
 * @version		:1.0
 */
public class RoleOperRelService implements IRoleOperRelService {

	/** The roleoperrel manager. */
	public IRoleOperRelManager roleoperrelManager=null;
	
	/**
	 * Instantiates a new role oper rel service.
	 */
	public RoleOperRelService() {
		roleoperrelManager=(IRoleOperRelManager)ApplicationContextHolder.webApplicationContext.getBean("roleoperrelManager");
	}
	...
	public void delete(Object[] object) {
		roleoperrelManager.delete(object);
	...
	public void deleteById(String pkid) {
		roleoperrelManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=roleoperrelManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=roleoperrelManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=roleoperrelManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=roleoperrelManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=roleoperrelManager.save(object);
		return saveobject;
	}
	...
	public void save(Object[] object) {
		roleoperrelManager.save(object);
	...
	public void update(Object object) {
		roleoperrelManager.update(object);
	...
	/* (non-Javadoc)
	 * @see com.soaplat.sysmgr.serviceiface.IRoleOperRelService#getRoleOperators(java.lang.String)
	 */
	public List getRoleOperators(String roleid) {
		List list=roleoperrelManager.getRoleOperators(roleid);
		return list;
	}
	...
	public List findbyExample(Object exampleentity) {
		List list=roleoperrelManager.findbyExample(exampleentity);
		return list;
	}
}
