...
import com.soaplat.sysmgr.serviceiface.IDictTypeService;

/**
 * Title 		:the Class DictTypeService.
 * Description	:
...
public class DictTypeService implements IDictTypeService {
	...
	/** The dicttype manager. */
	IDictTypeManager dicttypeManager=null;
	
	/**
	 * Instantiates a new dict type service.
	 */
	public DictTypeService() {
		dicttypeManager=(IDictTypeManager)ApplicationContextHolder.webApplicationContext.getBean("dicttypeManager");
		}
	...
	public void deleteById(String pkid) {
		dicttypeManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=dicttypeManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=dicttypeManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=dicttypeManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=dicttypeManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=dicttypeManager.save(object);
		return saveobject;
	}
	...
	public List findbyExample(Object exampleentity) {
		List list=dicttypeManager.findbyExample(exampleentity);
		return list;
	}
}
