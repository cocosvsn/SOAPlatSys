...
import com.soaplat.sysmgr.serviceiface.IIconSetService;

/**
 * Title 		:the Class IconSetService.
 * Description	:
 ...
 * @version		:1.0
 */
public class IconSetService implements IIconSetService {

	/** The iconset manager. */
	public IIconSetManager iconsetManager=null;
	
	/**
	 * Instantiates a new icon set service.
	 */
	public IconSetService() {
		iconsetManager=(IIconSetManager)ApplicationContextHolder.webApplicationContext.getBean("iconsetManager");
	}
	...
	public void deleteById(String pkid) {
		iconsetManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=iconsetManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=iconsetManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=iconsetManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=iconsetManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=iconsetManager.save(object);
		return saveobject;
	}
	...
	public List findbyExample(Object exampleentity) {
		List list=iconsetManager.findbyExample(exampleentity);
		return list;
	}

	/* (non-Javadoc)
	 * @see com.soaplat.sysmgr.serviceiface.IIconSetService#getIconSetName()
	 */
	public List getIconSetName() {
		List list=iconsetManager.getIconSetName();
		return list;
	}

	/* (non-Javadoc)
	 * @see com.soaplat.sysmgr.serviceiface.IIconSetService#getIconSetNameList()
	 */
	public List getIconSetNameList() {
		List list=iconsetManager.getIconSetNameList();
		return list;
	}
}
