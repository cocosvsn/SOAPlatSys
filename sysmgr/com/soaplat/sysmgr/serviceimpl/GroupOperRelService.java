...
import com.soaplat.sysmgr.serviceiface.IGroupOperRelService;


/**
 * Title 		:the Class GroupOperRelService.
 * Description	:
 ...
 * @version		:1.0
 */
public class GroupOperRelService implements IGroupOperRelService {

	/** The groupoperrel manager. */
	public IGroupOperRelManager groupoperrelManager=null;
	
	/**
	 * Instantiates a new group oper rel service.
	 */
	public GroupOperRelService() {
		groupoperrelManager=(IGroupOperRelManager)ApplicationContextHolder.webApplicationContext.getBean("groupoperrelManager");
	}
	...
	public void delete(Object[] object) {
		groupoperrelManager.delete(object);
	...
	public void deleteById(String pkid) {
		groupoperrelManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=groupoperrelManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=groupoperrelManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=groupoperrelManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=groupoperrelManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=groupoperrelManager.save(object);
		return saveobject;
	}
	...
	public void save(Object[] object) {
		groupoperrelManager.save(object);
	...
	public void update(Object object) {
		groupoperrelManager.update(object);
	...
	/* (non-Javadoc)
	 * @see com.soaplat.sysmgr.serviceiface.IGroupOperRelService#getGroupOperators(java.lang.String)
	 */
	public List getGroupOperators(String groupid) {
		List list=groupoperrelManager.getGroupOperators(groupid);
		return list;
	}
	...
	public List findbyExample(Object exampleentity) {
		List list=groupoperrelManager.findbyExample(exampleentity);
		return list;
	}

	public List getGroupRoleOperators(String groupid, String roleid) {
		List list=groupoperrelManager.getGroupRoleOperators(groupid, roleid);
		return list;
	}
}
