...
import com.soaplat.sysmgr.serviceiface.IMenuService;

/**
 * Title 		:the Class MenuService.
 * Description	:
...
public class MenuService implements IMenuService {
	...
	/** The menu manager. */
	public IMenuManager menuManager=null;
	
	/**
	 * Instantiates a new menu service.
	 */
	public MenuService() {
		menuManager=(IMenuManager)ApplicationContextHolder.webApplicationContext.getBean("menuManager");
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=menuManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=menuManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=menuManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=menuManager.save(object);
		return saveobject;
	}
	...
	public List findbyExample(Object exampleentity) {
		List list=menuManager.findbyExample(exampleentity);
		return list;
	}
}
