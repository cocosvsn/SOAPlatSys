...
import com.soaplat.sysmgr.serviceiface.IRoleFunRelService;

/**
 * Title 		:the Class RoleFunRelService.
 * Description	:
 ...
 * @version		:1.0
 */
public class RoleFunRelService implements IRoleFunRelService {

	/** The rolefunrel manager. */
	public IRoleFunRelManager rolefunrelManager=null;
	
	/**
	 * Instantiates a new role fun rel service.
	 */
	public RoleFunRelService() {
		rolefunrelManager=(IRoleFunRelManager)ApplicationContextHolder.webApplicationContext.getBean("rolefunrelManager");
	}
	...
	public void delete(Object[] object) {
		rolefunrelManager.delete(object);
	...
	public void deleteById(String pkid) {
		rolefunrelManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=rolefunrelManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=rolefunrelManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=rolefunrelManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=rolefunrelManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=rolefunrelManager.save(object);
		return saveobject;
	}
	...
	public void update(Object object) {
		rolefunrelManager.update(object);
	...
	/* (non-Javadoc)
	 * @see com.soaplat.sysmgr.serviceiface.IRoleFunRelService#getRoleFunResources(java.lang.String)
	 */
	public List getRoleFunResources(String roleid) {
		List list=rolefunrelManager.getRoleFunResources(roleid);
		return list;
	}
	...
	public List findbyExample(Object exampleentity) {
		List list=rolefunrelManager.findbyExample(exampleentity);
		return list;
	}
}
