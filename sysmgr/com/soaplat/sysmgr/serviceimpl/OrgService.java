...
import com.soaplat.sysmgr.serviceiface.IOrgService;

/**
 * Title 		:the Class OrgService.
 * Description	:
...
public class OrgService implements IOrgService {
	...
	/** The org manager. */
	public IOrgManager orgManager=null;
	
	/**
	 * Instantiates a new org service.
	 */
	public OrgService() {
		orgManager=(IOrgManager)ApplicationContextHolder.webApplicationContext.getBean("orgManager");
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=orgManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=orgManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=orgManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=orgManager.save(object);
		return saveobject;
	}
	...
	public List findbyExample(Object exampleentity) {
		List list=orgManager.findbyExample(exampleentity);
		return list;
	}
}
