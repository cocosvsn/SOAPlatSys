...
import com.soaplat.amsmgr.serviceiface.IAmsFileServerService;
import com.soaplat.sysmgr.common.ApplicationContextHolder;


/**
 * Title 		:the Class AmsFileServerService.
 * Description	:
 ...
 * @version		:1.0
 */
public class AmsFileServerService implements IAmsFileServerService {

	/** The fileserver manager. */
	public IAmsFileServerManager fileserverManager=null;
	
	/**
	 * Instantiates a new ams file server service.
	 */
	public AmsFileServerService() {
		fileserverManager=(IAmsFileServerManager)ApplicationContextHolder.webApplicationContext.getBean("amsfileserverManager");
	}
	...
	public void delete(Object[] object) {
		fileserverManager.delete(object);
	...
	public void deleteById(String pkid) {
		fileserverManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=fileserverManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=fileserverManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=fileserverManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=fileserverManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=fileserverManager.save(object);
		return saveobject;
	}
	...
	public void update(Object object) {
		fileserverManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=fileserverManager.findbyExample(exampleentity);
		return list;
	}
