...
import com.soaplat.amsmgr.serviceiface.IAmsFileSScheduleService;
import com.soaplat.sysmgr.common.ApplicationContextHolder;


/**
 * Title 		:the Class AmsFileSScheduleService.
 * Description	:
 ...
 * @version		:1.0
 */
public class AmsFileSScheduleService implements IAmsFileSScheduleService {

	/** The filesschedule manager. */
	public IAmsFileSScheduleManager filesscheduleManager=null;
	
	/**
	 * Instantiates a new ams file s schedule service.
	 */
	public AmsFileSScheduleService() {
		filesscheduleManager=(IAmsFileSScheduleManager)ApplicationContextHolder.webApplicationContext.getBean("amsfilesscheduleManager");
	}
	...
	public void delete(Object[] object) {
		filesscheduleManager.delete(object);
	...
	public void deleteById(String pkid) {
		filesscheduleManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=filesscheduleManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=filesscheduleManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=filesscheduleManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=filesscheduleManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=filesscheduleManager.save(object);
		return saveobject;
	}
	...
	public void save(Object[] object) {
		filesscheduleManager.save(object);
	...
	public void update(Object object) {
		filesscheduleManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=filesscheduleManager.findbyExample(exampleentity);
		return list;
	}
}
