...
import com.soaplat.amsmgr.serviceiface.IAmsStorageRouteService;
import com.soaplat.sysmgr.common.ApplicationContextHolder;


/**
 * Title 		:the Class AmsStorageRouteService.
 * Description	:
 ...
 * @version		:1.0
 */
public class AmsStorageRouteService implements IAmsStorageRouteService {

	/** The storageroute manager. */
	public IAmsStorageRouteManager storagerouteManager=null;
	
	/**
	 * Instantiates a new ams storage route service.
	 */
	public AmsStorageRouteService() {
		storagerouteManager=(IAmsStorageRouteManager)ApplicationContextHolder.webApplicationContext.getBean("amsstoragerouteManager");
	}
	...
	public void delete(Object[] object) {
		storagerouteManager.delete(object);
	...
	public void deleteById(String pkid) {
		storagerouteManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=storagerouteManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=storagerouteManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=storagerouteManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=storagerouteManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=storagerouteManager.save(object);
		return saveobject;
	}
	...
	public void save(Object[] object) {
		storagerouteManager.save(object);
	...
	public void update(Object object) {
		storagerouteManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=storagerouteManager.findbyExample(exampleentity);
		return list;
	}
}
