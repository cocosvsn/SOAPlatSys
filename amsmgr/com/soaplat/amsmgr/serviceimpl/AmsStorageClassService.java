...
import com.soaplat.amsmgr.serviceiface.IAmsStorageClassService;
import com.soaplat.sysmgr.common.ApplicationContextHolder;

/**
 * Title 		:the Class AmsStorageClassService.
 * Description	:
 ...
 * @version		:1.0
 */
public class AmsStorageClassService implements IAmsStorageClassService {

	/** The storageclass manager. */
	public IAmsStorageClassManager storageclassManager = null;
	
	/**
	 * Instantiates a new ams storage class service.
	 */
	public AmsStorageClassService() {
		storageclassManager=(IAmsStorageClassManager)ApplicationContextHolder.webApplicationContext.getBean("amsstorageclassManager");
	}
	...
	public void delete(Object[] object) {
		storageclassManager.delete(object);
	...
	public void deleteById(String pkid) {
		storageclassManager.deleteById(pkid);
	 ...
	 */
	public List findAll() {
		List list=storageclassManager.findAll();
		return list;
	}
	...
	public List findByProperty(String propertyName, Object value) {
		List list=storageclassManager.findByProperty(propertyName, value);
		return list;
	}
	...
	public Object getById(String pkid) {
		Object object=storageclassManager.getById(pkid);
		return object;
	}
	...
	public Object loadById(String pkid) {
		Object object=storageclassManager.loadById(pkid);
		return object;
	}
	...
	public Object save(Object object) {
		Object saveobject=storageclassManager.save(object);
		return saveobject;
	}
	...
	public void save(Object[] object) {
		storageclassManager.save(object);
	...
	public void update(Object object) {
		storageclassManager.update(object);
	...
	public List findbyExample(Object exampleentity) {
		List list=storageclassManager.findbyExample(exampleentity);
		return list;
	}
