...
//		FROM 
//			CMSADMIN.TPROGLISTDETAIL PD LEFT JOIN CMSADMIN.TCMSPROGPACKAGE PK ON PD.PRODUCTID = PK.PRODUCTID 
//			LEFT JOIN SOAPLATDB.TSOAAMSSTORAGEPRGREL REL ON PK.PRODUCTID = REL.PRGLOBALID
//			LEFT JOIN SOAPLATDB.TSOAAMSSTORAGEDIR DIR ON REL.STDIRGLOBALID = DIR.STDIRGLOBALID
//			LEFT JOIN SOAPLATDB.TSOAAMSSTORAGE S ON REL.STGLOBALID = S.STGLOBALID
//			LEFT JOIN SOAPLATDB.TSOAAMSSTORAGECLASS C ON C.STCLASSGLOBALID = S.STCLASSGLOBALID
//			LEFT JOIN CMSADMIN.TPRODUCTINFO PI ON PD.PRODUCTINFOID = PI.PRODUCTINFOID
//
//		WHERE PD.SCHEDULEDATE BETWEEN '20110823000000' AND '20110824000000' AND C.STCLASSCODE = 'Online'--'CaOnline' 
//		AND PK.PRODUCTID NOT IN
//		(
//			SELECT DISTINCT PD.PRODUCTID FROM CMSADMIN.TPROGLISTDETAIL PD WHERE PD.SCHEDULEDATE NOT BETWEEN '20110824000000' AND '20110824000000'
...
//		   (CASE WHEN PK.PRODUCTID IN (SELECT PLD.PRODUCTID FROM CMSADMIN.TPROGLISTDETAIL PLD WHERE PLD.SCHEDULEDATE > '20110825000000') THEN '否' ELSE '是' END) AS 是否可删除
//		FROM 
...
//"SUM"(PF.CONTENTFILESIZE) AS 节目包大小,
//(CASE WHEN PK.PRODUCTID IN (SELECT PLD.PRODUCTID FROM CMSADMIN.TPROGLISTDETAIL PLD WHERE PLD.SCHEDULEDATE > '20110824000000') THEN '否' ELSE '是' END) AS 是否可删除, C.STCLASSCODE
//FROM 
//CMSADMIN.TPROGLISTDETAIL PD INNER JOIN CMSADMIN.TCMSPROGPACKAGE PK ON PD.PRODUCTID = PK.PRODUCTID 
//INNER JOIN SOAPLATDB.TSOAAMSSTORAGEPRGREL REL ON PK.PRODUCTID = REL.PRGLOBALID
//INNER JOIN SOAPLATDB.TSOAAMSSTORAGEDIR DIR ON REL.STDIRGLOBALID = DIR.STDIRGLOBALID
...
//WHEN 1 < (SELECT "COUNT"(*) FROM SOAPLATDB.TSOAAMSSTORAGEPRGREL WHERE SOAPLATDB.TSOAAMSSTORAGEPRGREL.PRGLOBALID = PK.PRODUCTID 
//AND SOAPLATDB.TSOAAMSSTORAGEPRGREL.STGLOBALID IN ('20090903143323000954')) THEN '否' ELSE '是' END) AS 是否可删除, C.STCLASSCODE
//FROM 
//CMSADMIN.TPROGLISTDETAIL PD INNER JOIN CMSADMIN.TCMSPROGPACKAGE PK ON PD.PRODUCTID = PK.PRODUCTID 
//INNER JOIN SOAPLATDB.TSOAAMSSTORAGEPRGREL REL ON PK.PRODUCTID = REL.PRGLOBALID
//INNER JOIN SOAPLATDB.TSOAAMSSTORAGEDIR DIR ON REL.STDIRGLOBALID = DIR.STDIRGLOBALID
...
//"SUM"(PF.CONTENTFILESIZE) AS 节目包大小,
//(CASE WHEN PK.PRODUCTID IN (SELECT PLD.PRODUCTID FROM CMSADMIN.TPROGLISTDETAIL PLD WHERE PLD.SCHEDULEDATE > :safeScheduleDate) THEN '否' 
//WHEN 0 < (SELECT "COUNT"(*) FROM SOAPLATDB.TSOAAMSSTORAGEPRGREL WHERE SOAPLATDB.TSOAAMSSTORAGEPRGREL.PRGLOBALID = PK.PRODUCTID 
//AND SOAPLATDB.TSOAAMSSTORAGEPRGREL.STGLOBALID IN ('20090903143323000954', '20090903143323000955')) THEN '否' ELSE '是' END) AS 是否可删除, C.STCLASSCODE
//FROM 
//CMSADMIN.TPROGLISTDETAIL PD INNER JOIN CMSADMIN.TCMSPROGPACKAGE PK ON PD.PRODUCTID = PK.PRODUCTID 
//INNER JOIN SOAPLATDB.TSOAAMSSTORAGEPRGREL REL ON PK.PRODUCTID = REL.PRGLOBALID
//INNER JOIN SOAPLATDB.TSOAAMSSTORAGEDIR DIR ON REL.STDIRGLOBALID = DIR.STDIRGLOBALID
